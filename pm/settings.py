...
DATABASES = {
    'default': {
        ...
        'NAME': 'pm.db',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    os.path.join(RUTA_PROYECTO, 'statics'),
)
...
SECRET_KEY = 'o_jombau6=3%c4v&-%k!5$h!w&ttm!jwb)!ct*z04u%stiz=am'
...
EMAIL_PORT = 26
DEFAULT_FROM_EMAIL = 'no_reply@pm.hn'
