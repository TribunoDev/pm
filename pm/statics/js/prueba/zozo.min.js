...
(window.jQuery), ! function (e) {
 ...
 (function (e, t, n, r) {
     ...
     i["prototype"] = {
         ...
         init: function () {
             ...
             if (t["settings"]["slider"] === true) {
                 ...
                 if (t["settings"]["dotNav"] === true && t["settings"]["slider"] === true) {
                     t["$sections"] = t["$elem"]["find"](m);
                     var n = e("<div class='" + E + "'></div>");
             ...
             if (t["settings"]["contentUrls"] != null) {
                 t["$sections"]["each"](function (n, r) {
                     e(r)["find"]("." + s["classes"]["link"])["data"](b, t["settings"]["contentUrls"][n])
                 })
             }
         ...
         add: function (e, t, n) {
             var r = this;
             var i = P["create"](r, e, t);
             i["appendTo"](r.$elem);
             P["updateClasses"](r);
             P["bindEvent"](r, i["find"](g));
             return r
         },
         remove: function (t) {
             var n = this;
     ...
     var P = {
         ...
         updateClasses: function (t, n) {
             ...
             t["$sections"]["filter"](":first-child")["addClass"](s["classes"]["first"])["find"](g)["attr"]("tabindex", "0")["attr"]("accesskey", "w");
             ...
             jQuery["browser"]["mobile"] === true && t["$elem"]["addClass"](S);
         ...
         setContentSize: function (t) {
             ...
             t["$sections"]["each"](function (f, l) {
                 ...
                 if (!c["find"]("> * >." + s["classes"]["autoClass"])["length"]) {
         ...
         bindEvents: function (n) {
             ...
             n["$elem"]["bind"](w, n["settings"]["contentLoad"]);
         ...
         showSection: function (t, n, r) {
             var i = t["$elem"]["find"](m)["eq"](n);
             var o = t["settings"]["animation"]["duration"];
             var a = {
             ...
             if (a["enabled"]) {
                 ...
                 if (a["contentUrl"]) {
                     t["settings"]["orientation"] === s["classes"]["orientations"]["vertical"] ? P["ajaxRequest"](t, a, P["showVertical"]) : P["ajaxRequest"](t, a, P["showHorizontal"])
                 } else {
                     t["settings"]["orientation"] === s["classes"]["orientations"]["vertical"] ? P["showVertical"](t, a) : P["showHorizontal"](t, a)
                 }
                 P["updateDotNav"](t, a);
                 P["addAria"](t, a);
                 t["currentsection"] = a["index"]
             }
             return t
         },
         showHorizontal: function (t, n) {
             ...
             t["$sections"]["each"](function (r, h) {
                 ...
                 t["$elem"]["find"]("> *." + x + " > .z-content")["parent"]()["removeClass"](s["classes"]["active"]);
                 t["$elem"]["find"]("> * > .z-content")["eq"](l)["parent"]()["toggleClass"](s["classes"]["active"]);
                 v["css"]({
                     outline: "none",
                     height: i + 1,
                     "line-height": i + o
         ...
         addAria: function (t, n) {
             t["$sections"]["each"](function (n, r) {
                 ...
                 var o = i["find"](g);
                 var u = i["find"]("> div");
                 var a = i["hasClass"](s["classes"]["active"]);
                 i["attr"]({
                     "aria-hidden": (!a).toString(),
                     "aria-expanded": a.toString(),
                     "aria-selected": a.toString()
                 });
                 o["attr"]({
                     "aria-controls": t["elemID"] + "-" + (n + 1),
                     role: "tab",
                     tabindex: "-1"
                 });
                 u["attr"]({
             ...
             if (!n["section"]["hasClass"](s["classes"]["active"])) {
                 ...
                 e["ajax"]({
                     ...
                     complete: function (e, s) {
                         setTimeout(function () {
                             clearTimeout(i);
                             n["link"]["find"](a)["removeClass"](C)
                         }, 0);
                         r && typeof r == typeof Function && r(t, n)
                     },
                     success: function (e, r, i) {
                         n["contentInner"]["html"](e);
                         t["settings"]["contentLoad"] && typeof t["settings"]["contentLoad"] == typeof Function && t["$elem"]["trigger"](w, {
                             header: n["link"][0],
         ...
         isTabDisabled: function (e) {
             return e["hasClass"](N) || e["data"](T) === true
         },
         create: function (t, n, r) {
             var i = t["settings"]["headerTag"];
             var s = t["settings"]["sectionTag"];
             return e("<" + s + "><" + i + ">" + n + "</" + i + "><div>" + r + "</div></" + s + ">")
         }
     };
     i["defaults"] = i["prototype"]["defaults"];
     ...
     e["zozo"]["core"]["hashHelper"] = {
         ...
         get: function (e, t) {
             ...
             if (this["isSimple"](t)) {
                 ...
                 if (typeof n === "undefined" || typeof n["length"] < 0) {
                     return null
                 } else {
                     if (typeof n[e] !== "undefined" && n[e] !== null) {
                         return n[e]
                     } else {
                         return null
                     }
         ...
         set: function (e, t, r, i) {
             if (this["isSimple"](r)) {
                 ...
                 if (i === "multiple") {
                     ...
                     n["location"]["hash"] = o["join"]("&")
                 } else {
                     n["location"]["hash"] = e + r + t
                 }
             }
         },
         isSimple: function (e) {
 ...
 (function (e, t, n, r) {
     ...
     var i = function (t, n) {
         ...
         this["currentTab"];
         this["BrowserDetection"] = e["zozo"]["core"]["browser"];
         this["Deeplinking"] = e["zozo"]["core"]["hashHelper"];
         this["lastWindowHeight"];
         this["lastWindowWidth"];
         this["responsive"]
     };
     ...
     i["prototype"] = {
         ...
         init: function () {
             var r = this;
             r["settings"] = e["extend"](true, {}, r["defaults"], r["options"], r["metadata"], r["attrdata"]);
             r["$elem"]["find"](">." + x)["remove"]();
             r["$elem"]["removeClass"]("z-tabs-loading");
             if (r["settings"]["contentUrls"] != null) {
                 r["$elem"]["find"]("> div > div")["each"](function (t, n) {
                     e(n)["data"](v, r["settings"]["contentUrls"][t])
                 })
             }
             z["initAnimation"](r, true);
             z["updateClasses"](r);
             z["checkWidth"](r, true);
             z["bindEvents"](r);
             z["initAutoPlay"](r);
             e["zozo"]["core"]["plugins"]["easing"](r);
             var i = r["settings"]["deeplinkingPrefix"] ? r["settings"]["deeplinkingPrefix"] : r["tabID"];
             if (r["settings"]["deeplinking"] === true) {
                 if (n["location"]["hash"]) {
                     var s = r["Deeplinking"]["get"](i, r["settings"]["deeplinkingSeparator"]);
                     var o = r["$tabs"]["filter"]("li[" + r["settings"]["hashAttribute"] + "='" + s + "']")["length"];
                     if (o) {
                         z["showTab"](r, s)
                     } else {
                         z["showTab"](r, r["settings"]["defaultTab"])
                     }
                 } else {
                     z["showTab"](r, r["settings"]["defaultTab"])
                 } if (typeof e(t)["hashchange"] != "undefined") {
                     e(t)["hashchange"](function () {
                         var e = r["Deeplinking"]["get"](i, r["settings"]["deeplinkingSeparator"]);
                 ...
                 if (r["settings"]["noTabs"] === true) {
                     z["showContent"](r, z["getActive"](r, 0))
                 } else {
                     z["showTab"](r, r["settings"]["defaultTab"])
                 }
             }
         ...
         setOptions: function (t) {
             ...
             n["settings"] = e["extend"](true, n["settings"], t);
             z["initAnimation"](n);
             z["updateClasses"](n, true);
             z["checkWidth"](n, false, true);
             z["initAutoPlay"](n);
             return n
         },
         add: function (e, t, n) {
         ...
         select: function (e) {
             ...
             if (t["settings"]["animating"] !== true) {
                 if (t["settings"]["noTabs"] === true) {
                     z["showContent"](t, z["getActive"](t, e))
                 } else {
                     z["changeHash"](t, t["$tabs"]["eq"](e)["attr"](t["settings"]["hashAttribute"]))
                 }
             }
             return t
         },
         ...
         prev: function () {
             var t = this;
             var n = z["getActiveIndex"](t);
             if (n <= z["getFirst"](t)) {
                 t["select"](z["getLast"](t))
             } else {
                 t["select"](n - 1);
     ...
     var z = {
         ...
         updateClasses: function (t, n) {
             ...
             t["$elem"]["removeClass"](s["classes"]["wrapper"])["removeClass"](s["classes"]["rounded"])["removeClass"](s["classes"]["shadows"])["removeClass"](s["classes"]["spaced"])["removeClass"](s["classes"]["bordered"])["removeClass"](s["classes"]["dark"])["removeClass"](j)["removeClass"](E)["removeClass"](S)["removeClass"](w)["removeClass"](o)["removeClass"](s["classes"]["styles"]["join"](s["space"]))["removeClass"](s["classes"]["orientations"]["join"](s["space"]))["removeClass"](u["join"]()["replace"](s["commaRegExp"], s["space"]))["removeClass"](s["classes"]["sizes"]["join"](s["space"]))["removeClass"](s["classes"]["themes"]["join"](s["space"]))["removeClass"](s["classes"]["flatThemes"]["join"](s["space"]))["addClass"](h)["addClass"](t["settings"]["style"])["addClass"](t["settings"]["size"])["addClass"](t["settings"]["theme"]);
             z["isFlatTheme"](t) && t["$elem"]["addClass"](o);
             z["isLightTheme"](t) ? t["$elem"]["addClass"](S) : t["$elem"]["addClass"](E);
             ...
             t["settings"]["multiline"] === true && t["$elem"]["addClass"](j);
             z["checkPosition"](t);
             if (t["$elem"]["find"]("> ul." + "z-tabs-mobile")["length"]) {
                 ...
                 if (t["$elem"]["find"]("> i." + q)["length"]) {
                     t["$mobileDropdownArrow"] = t["$elem"]["find"]("> i." + q)
                 } else {
         ...
         checkPosition: function (t) {
             ...
             if (t["settings"]["orientation"] === L) {
                 if (t["settings"]["position"] !== M) {
                     t["settings"]["position"] = O
                 }
             } else {
                 t["settings"]["orientation"] = A;
                 if (n === false) {
                     t["$tabGroup"]["appendTo"](t.$elem);
                     e(s["elementSpacer"])["appendTo"](t.$elem);
                     t["$container"]["prependTo"](t.$elem)
         ...
         bindEvent: function (n, r) {
             r["on"]("ztap", {
                 ...
                 z["changeHash"](n, r["attr"](n["settings"]["hashAttribute"]));
                 if (z["allowAutoScrolling"](n) === true && z["isMobile"](n)) {
         ...
         mobileNavAutoScroll: function (n) {
             if (z["allowAutoScrolling"](n) === true) {
                 e(t["opera"] ? "html" : "html, body")["animate"]({
         ...
         showTab: function (e, t) {
             var n = e["$tabs"]["filter"]("li[" + e["settings"]["hashAttribute"] + "='" + t + "']")["length"];
             if (n && t != null && e["settings"]["animating"] !== true) {
                 var r = e["$tabs"]["filter"]("li[" + e["settings"]["hashAttribute"] + "='" + t + "']");
                 var i = e["$tabs"]["index"](r);
                 var o = z["getActive"](e, i);
                 if (o["enabled"] && o["preIndex"] !== o["index"] && e["settings"]["noTabs"] !== true) {
                     e["currentTab"] = r;
                     e["$tabs"]["removeClass"](s["classes"]["active"]);
                     e["currentTab"]["addClass"](s["classes"]["active"]);
                     z["mobileNav"](e, false, o["index"]);
                     if (o["contentUrl"]) {
                         if (o["preIndex"] === -1) {
                             o["content"]["css"]({
                                 opacity: "",
         ...
         getActive: function (t, n) {
             ...
             var l = {
                 ...
                 enabled: z["isTabDisabled"](o) === false,
                 contentUrl: i["data"](v),
                 contentType: i["data"](m),
                 noAnimation: false,
                 transition: a,
                 duration: f,
                 preIndex: r,
         ...
         iframeContent: function (e, t) {
             var n = t["contentInner"]["find"]("> div >.z-iframe");
             if (!n["length"]) {
                 z["showLoading"](e);
                 t["contentInner"]["append"]('<div class="z-video"><iframe src="' + t["contentUrl"] + '" frameborder="0" scrolling="auto" height="1400" class="z-iframe"></iframe></div>');
                 console["log"]("add iframe")
             } else {
                 z["hideLoading"](e)
             }
             z["showContent"](e, t);
             t["contentInner"]["find"](".z-iframe")["load"](function () {
                 z["hideLoading"](e)
             });
             return e
         },
         showLoading: function (e) {
             e["$container"]["append"]('<span class="' + x + '"></span>');
             return e
         },
         hideLoading: function (e) {
             e["$container"]["find"](">." + x)["remove"]();
             return e
         },
         ...
         showContent: function (e, t) {
             if (t["preIndex"] !== t["index"] && e["settings"]["animating"] !== true) {
                 ...
                 if (t["preIndex"] === -1) {
                     ...
                     var n = e["settings"]["animation"]["effects"];
                     var r = z["getContentHeight"](e, t["preContent"], true)["height"];
                     var i = z["getContentHeight"](e, t["content"], true)["height"];
                     var o = z["isLarger"](r, i);
                     if (e["settings"]["orientation"] === A && e["settings"]["autoContentHeight"] === true) {
                         o = r > i ? r : i
                     }
                     var u = n === s["animation"]["effects"]["slideH"] || n === s["animation"]["effects"]["slideLeft"] || n === s["animation"]["effects"]["slideRight"] ? e["$container"]["width"]() : u = o;
                     if (t["preIndex"] < t["index"] && n === s["animation"]["effects"]["slideV"]) {
                         var a = z["isLarger"](r, i);
                         a > u && (u = a)
                     }
                     var f = -u;
                     var l = u;
                     ...
                     W["before"](e, t);
                     switch (n) {
                     case s["animation"]["effects"]["slideV"]:
                         z["animate"](e, t["preContent"], null, {
                             left: 0,
                             top: f + "px"
                         });
                         z["animate"](e, t["content"], {
                             left: 0,
                             top: l + "px"
                         }, {
                             top: 0
                         ...
                         break;;
                     case s["animation"]["effects"]["slideUp"]:
                         z["animate"](e, t["preContent"], {
                             opacity: 1
                         }, {
                             left: 0,
                             top: -u + "px"
                         ...
                         break;;
                     case s["animation"]["effects"]["slideDown"]:
                         z["animate"](e, t["preContent"], {
                             opacity: 1
                         }, {
                             left: 0,
                         ...
                         break;;
                     case s["animation"]["effects"]["slideUpDown"]:
                         z["animate"](e, t["preContent"], {
                             opacity: 1
                         }, {
                             left: 0,
                         ...
                         break;;
                     case s["animation"]["effects"]["slideH"]:
                         z["animate"](e, t["preContent"], null, {
                             left: f + "px"
                         });
                         z["animate"](e, t["content"], {
                         ...
                         break;;
                     case s["animation"]["effects"]["slideRight"]:
                         z["animate"](e, t["preContent"], {
                             opacity: 1
                         }, {
                             top: 0,
                         ...
                         break;;
                     case s["animation"]["effects"]["slideLeft"]:
                         z["animate"](e, t["preContent"], {
                             opacity: 1
                         }, {
                             top: 0,
         ...
         checkWidth: function (t, n, r) {
             ...
             z["setResponsiveDimension"](t, t["settings"]["original"]["groupWidth"]);
             if (t["settings"]["original"]["count"] > 3 && t["settings"]["original"]["lastRowItems"] === 1) {
                 ...
                 z["setResponsiveDimension"](t, t["settings"]["original"]["groupWidth"], true)
             }
             if (n === true || r === true) {
             ...
             var c = z["isCompact"](t) && !z["isMobile"](t);
             var h = z["isResponsive"](t) && t["BrowserDetection"]["isIE"](7) ? {
                 "float": "none",
                 width: "auto"
             } : {
                 "float": ""
             };
             var p = t["$elem"]["hasClass"](R);
             ...
             if (t["settings"]["orientation"] === L) {
                 z["setContentHeight"](t, null, true)
             }
         },
         ...
         getContentHeight: function (t, n, r) {
             ...
             if (i != true) {
                 ...
                 s["height"] = z["getElementSize"](o)["height"]
             } if (t["settings"]["orientation"] === L && !z["isMobile"](t)) {
                 var u = 0;
                 ...
                 s["height"] = z["isLarger"](s["height"], t["$tabGroup"]["innerHeight"]());
                 s["height"] = z["isLarger"](s["height"], u)
             }
             return s
         },
         setContentHeight: function (t, n, r) {
             var i = z["getContentHeight"](t, n, r);
             ...
             if (r === true) {
                 ...
                 z["animate"](t, t.$container, null, f, {})
             }
             return t
         },
         responsive: function (n, r) {
             ...
             if (n["settings"]["orientation"] === A) {
                 ...
                 if (y) {
                     ...
                     z["switchResponsiveClasses"](n, true)
                 } else {
                     if (u) {
                         var b = 100 / n["settings"]["original"]["count"];
                         n["$tabs"]["each"](function () {
                             e(this)["css"]({
                                 "float": "",
                                 width: b + "%"
         ...
         switchMenu: function (t, n) {
             ...
             if (n === true) {
                 ...
                 t["settings"]["style"] === T ? t["$elem"]["addClass"]("m-" + t["settings"]["theme"]) : t["$elem"]["addClass"](t["settings"]["theme"])
             } else {
                 t["$elem"]["addClass"](t["settings"]["orientation"]);
         ...
         changeHash: function (n, r) {
             ...
             if (n["settings"]["animating"] !== true) {
                 if (n["settings"]["deeplinking"] === true) {
                     if (typeof e(t)["hashchange"] != "undefined") {
                         n["Deeplinking"]["set"](i, r, n["settings"]["deeplinkingSeparator"], n["settings"]["deeplinkingMode"])
                     } else {
         ...
         isLightTheme: function (t) {
             ...
             var r = true;
             var i = z["isFlatTheme"](t);
             if (t["settings"]["style"] !== T) {
         ...
         isResponsive: function (e) {
             return e["$elem"]["hasClass"](R) === true
         },
         isMobile: function (e) {
             return e["$elem"]["hasClass"](B) === true
         },
         isTabDisabled: function (e) {
             return e["hasClass"](b) || e["data"](g) === true
         },
     ...
     var W = {
         init: function (t, n) {
             ...
             if (t["settings"]["orientation"] === L) {
                 z["setContentHeight"](t, n["content"], true)
             }
             return t
         },
         before: function (t, n) {
             ...
             if (t["settings"]["animation"]["effects"] !== s["animation"]["effects"]["none"]) {
                 z["setContentHeight"](t, n["preContent"], true);
                 z["setContentHeight"](t, n["content"])
             }
             t["$container"]["addClass"](I);
             n["preContent"]["css"]({
                 position: "absolute",
                 display: "block",
                 left: 0,
         ...
         after: function (e, t) {
             ...
             setTimeout(function () {
                 ...
                 var n = e["settings"]["orientation"] === L ? {
                     height: ""
                 } : {
                     height: "",
                     "min-height": "",
 ...
 $(document).ready(function () {
     $(".demo-h-tab").load("../demos/demo05.htm", function (e) {
         $(".demo-h-tab .tabbed-nav").zozoTabs(demo_h)
     });
     $(".demo-v-tab").load("../demos/demo05.htm", function (e) {
     ...
     $("#section-flat-contained #clean-demo01").load("../demos/demo-multiline.htm", function (e) {
         $("#section-flat-contained #clean-demo01").zozoTabs(demo_flat)
     });
     $("#section-flat-contained #clean-demo02").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-flat-contained #clean-demo02").zozoTabs(demo_flat)
     });
     $("#section-flat-mobile #demo-tabs").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-flat-mobile #demo-tabs").zozoTabs(demo_flat)
     });
     $("#section-flat-mobile #demo-tabs2").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-flat-mobile #demo-tabs2").zozoTabs(demo_flat)
     });
     $("#section-flat-mobile #demo-tabs3").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-flat-mobile #demo-tabs3").zozoTabs(demo_flat)
     });
     $("#section-flat-mobile-dark #demo-tabs").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-flat-mobile-dark #demo-tabs").zozoTabs(demo_flat)
     });
     $("#section-flat-mobile-dark #demo-tabs2").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-flat-mobile-dark #demo-tabs2").zozoTabs(demo_flat)
     });
     $("#section-flat-mobile-dark #demo-tabs3").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-flat-mobile-dark #demo-tabs3").zozoTabs(demo_flat)
     });
     $("#section-mobile #demo-tabs").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-mobile #demo-tabs").zozoTabs(demo_flat)
     });
     $("#section-mobile #demo-tabs2").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-mobile #demo-tabs2").zozoTabs(demo_flat)
     });
     $("#section-mobile #demo-tabs3").load("../demos/demo-mobile-05.htm", function (e) {
         $("#section-mobile #demo-tabs3").zozoTabs(demo_flat)
     });
     $(".accordion #section-vertical #demo-01").load("../demos/demo-basic.htm", function (e) {
         $(".accordion #section-vertical #demo-01").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-vertical #demo-02").load("../demos/demo-basic.htm", function (e) {
         $(".accordion #section-vertical #demo-02").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-vertical #demo-03").load("../demos/demo-basic.htm", function (e) {
         $(".accordion #section-vertical #demo-03").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-vertical-spacing #demo-01").load("../demos/demo-basic.htm", function (e) {
         $(".accordion #section-vertical-spacing #demo-01").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-vertical-spacing #demo-02").load("../demos/demo-basic.htm", function (e) {
         $(".accordion #section-vertical-spacing #demo-02").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-vertical-spacing #demo-03").load("../demos/demo-basic.htm", function (e) {
         $(".accordion #section-vertical-spacing #demo-03").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-slider #demo-01").load("../demos/demo-slider.htm", function (e) {
         $(".accordion #section-slider #demo-01").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-slider-spacing #demo-01").load("../demos/demo-slider.htm", function (e) {
         $(".accordion #section-slider-spacing #demo-01").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-navigation-menu #demo-01").load("../demos/demo-menu.htm", function (e) {
         $(".accordion #section-navigation-menu #demo-01").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-navigation-menu #demo-02").load("../demos/demo-menu.htm", function (e) {
         $(".accordion #section-navigation-menu #demo-02").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-navigation-menu #demo-03").load("../demos/demo-menu.htm", function (e) {
         $(".accordion #section-navigation-menu #demo-03").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-horizontal-to-vertical #demo-01").load("../demos/demo-basic.htm", function (e) {
         $(".accordion #section-horizontal-to-vertical #demo-01").zozoAccordion(demo_accordion)
     });
     $(".accordion #section-faq #demo-01").load("../demos/demo-faq.htm", function (e) {
         $(".accordion #section-faq #demo-01").zozoAccordion(demo_accordion)
     });
     $("#section-responsive #responsive-demo-01").load("../demos/demo-mobile.htm", function (e) {
         $("#section-responsive #responsive-demo-01").zozoTabs(demo_h)
     });
     $("#section-responsive #responsive-demo-02").load("../demos/demo-mobile.htm", function (e) {
         $("#section-responsive #responsive-demo-02").zozoTabs(demo_h)
     });
     $("#section-responsive #responsive-demo-03").load("../demos/demo-mobile.htm", function (e) {
         $("#section-responsive #responsive-demo-03").zozoTabs(demo_h)
     });
     $("#section-vertical .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $("#section-vertical .tabbed-nav").zozoTabs(demo_h)
     });
     $("#section-horizontal .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $("#section-horizontal .tabbed-nav").zozoTabs(demo_h)
     });
     $("#section-events .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $("#section-events .tabbed-nav").zozoTabs(demo_h)
     });
     $("#section-events .tabbed-nav").bind("select", function (e, t) {
         $.zozo.core.console.log("Selected: " + t.tab.text())
     });
     $("#section-events .tabbed-nav").bind("deactivate", function (e, t) {
         $.zozo.core.console.log("Deactivated: " + t.tab.text())
     });
     $("#section-multiline #multiline-demo01").load("../demos/demo-multiline.htm", function (e) {
         $("#section-multiline #multiline-demo01").zozoTabs(demo_h)
     });
     $("#section-multiline #multiline-demo02").load("../demos/demo-multiline.htm", function (e) {
         $("#section-multiline #multiline-demo02").zozoTabs(demo_h)
     });
     $("#section-clean #clean-demo01").load("../demos/demo-multiline.htm", function (e) {
         $("#section-clean #clean-demo01").zozoTabs(demo_h)
     });
     $("#section-clean #clean-demo02").load("../demos/demo-multiline.htm", function (e) {
         $("#section-clean #clean-demo02").zozoTabs(demo_h)
     });
     $("#section-animation .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $("#section-animation .tabbed-nav").zozoTabs(demo_h)
     });
     $("#section-size .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $("#section-size .tabbed-nav").zozoTabs(demo_h)
     });
     $("#section-underlined #underlined-demo").load("../demos/demo05-content.htm", function (e) {
         $("#section-underlined #underlined-demo").zozoTabs(demo_h)
     });
     $("#section-underlined #underlined-demo-02").load("../demos/demo-mobile.htm", function (e) {
         $("#section-underlined #underlined-demo-02").zozoTabs(demo_h)
     });
     $("#section-autoplay .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $("#section-autoplay .tabbed-nav").zozoTabs(demo_h)
     });
     $("#section-layouts .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $("#section-layouts .tabbed-nav").zozoTabs(demo_h)
     });
     $(".deeplinking .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
         $(".deeplinking .tabbed-nav").zozoTabs(demo_h)
     });
     $("#section-dynamically .tabbed-nav").load("../demos/demo05-content.htm", function (e) {
     ...
     $(".add-dynamic-content").live("click", function (e) {
         e.preventDefault();
         $("#dynamic-content").html('<div class="z-video"><iframe width="560" height="315" src="http://www.youtube.com/embed/MOiyD26cJ2A" frameborder="0" allowfullscreen></iframe></div>')
     })
 });