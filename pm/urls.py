...
urlpatterns = patterns('',
   ...
   # url(r'^currencies/', include('currencies.urls')),
    ...
    url(r'^administrador/$', 'web.views.administrador', name='administrador'),
    ...
    url(r'^detalle-producto/(?P<id_producto>\S+)/$', 'web.views.detalle_producto', name='detalle_producto'),
    ...
    url(r'^novedades/$', 'web.views.productos_novedades', name='productos_novedades'),
    ...
    url(r'^user/password/reset/contrasena/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', password_reset_confirm,{'template_name': 'registration/password_reset_confirm.html', 'post_reset_redirect': '/user/password/done/'}, name='password_reset_confirm'),
    ...
    url(r'^filtro-oferta/$', 'web.views.filtro_oferta', name='filtro_oferta'),
    url(r'^filtro-destacados/$', 'web.views.filtro_destacados', name='filtro_destacados'),
    url(r'^filtro-novedades/$', 'web.views.filtro_novedades', name='filtro_novedades'),
